...
class CrawlerItem(scrapy.Item):
    photo=Field()#sonradan ekleme fotoğraf
    deneyanil=Field()#deneme yapmak için test
    price=Field()#sonradan ekleme fiyat
    country=Field()#sonradan ekleme ülke
    district=Field()#sonradan ekleme ilçe
    external_link = Field()
    external_id = Field()
    title = Field()
    description = Field()
